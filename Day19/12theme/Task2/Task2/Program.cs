...
{
    /// <summary>
    /// Главный класс программы, реализующий арифметические операции с использованием лямбда-выражений.
    /// </summary>
    class Program
    {
        /// <summary>
        /// Точка входа в программу.
        /// Запрашивает у пользователя данные и выполняет выбранное арифметическое действие.
        /// </summary>
        static void Main(string[] args)
        {
            ...
            /// <summary>
            /// Выполняет выбранное арифметическое действие с введенными числами.
            /// </summary>
